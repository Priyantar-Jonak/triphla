  ...
  return (
    <footer className="bg-gray-900 text-gray-300">
      ...
      <div className="w-full max-w-7xl mx-auto">
        {/* Top Section */}
        <div className="px-8 sm:px-6 lg:px-8 py-8 sm:py-12 lg:py-16">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 sm:gap-12 lg:gap-16">
            {/* Brand Section */}
            <div className="space-y-4 sm:space-y-6">
              <h2 className="text-2xl sm:text-3xl font-bold text-white">Triphla</h2>
              <p className="text-sm sm:text-base text-gray-400 max-w-md">
                The one stop platform for investing with AI-powered companions. 
                Confidential, secure, and always available.
              </p>
              {/* Social Links */}
            ...
            <div className="space-y-4 sm:space-y-6">
              ...
              <div className="space-y-3">
                <p className="flex items-center text-sm sm:text-base text-gray-400">
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z"/>
                  </svg>
                  sibajit_ug_23@ece.nits.ac.in
                </p>
                <p className="flex items-center text-sm sm:text-base text-gray-400">
                  <svg className="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="border-t border-gray-800">
          <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
            <div className="text-center sm:flex sm:justify-between sm:items-center">
              ...
              <div className="mt-2 sm:mt-0 text-xs sm:text-sm text-gray-400">
